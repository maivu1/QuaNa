...
function firstQuestion(){
    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            audio.play();
            Swal.fire({
                title: 'Hello Bạn yêu<3😘 ',
                text: 'Chúc Na lợn có 1 ngày 20-10 vui vẻ 😊, một ngày thật đằm thắm, cố gắng vượt qua khó khăn trong cuộc sống, vươn xa hơn và đi tới hạnh phúc 🥰🥰🥰',
                imageUrl: 'na1.jpg',
                background: '#fff url("iput-bg.jpg")',
                imageAlt: 'Custom image',
                confirmButtonText: 'Tiếp theo!😘'
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            ...
                            Swal.fire({
                                ...
                                background: '#fff url("iput-bg.jpg")',
                                imageAlt: 'Custom image',
                                confirmButtonText: 'Đùa thôi! Tiếp theo <3',
                            })
                            .then((result) => {
                                if (result.value) {
                                    audioDoaMa.pause();
                                    ...
                                    Swal.fire({
                                        ...
                                        if (result.value) {
                                            ...
                                            Swal.fire({
                                                width: 900,
                                                confirmButtonText: 'Món quà thật sự ở đây. Nhấn vào <3😜😜😜',
                                                background: '#fff url("iput-bg.jpg")',
